...
\begin{minipage}[t]{\minipageSize}\centering
  ...
  \caption[Brokovnica]{Hráč, ktorý je zasiahnutý kartou Bang! z tejto zbrane musí odhodiť kartu z ruky podľa svojho výberu. Dosah 1. Keď má hráč poslený život a má na ruke jedinú kartu, a to Pivo, odovzdáva Pivo hráćovi ktorý ho zasiahol a je vyradený z hry. }
  \skname{Brokovnica}
  \altnames{Shotgun}
  \label{fig:vedle}
\end{minipage}
...
\caption[Schofield]{Zvýšenie dosahu na 2.}
  \skname{Schofield}
  \label{fig:panico}
\end{minipage}
\end{figure}
