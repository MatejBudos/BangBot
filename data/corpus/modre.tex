\chapter{Modré karty}
Poradie ťahania na začiatku ťahu je: Dynamit $\rightarrow$ Väzenie $\rightarrow$ Chrastiač. Hráč zároveň nemôže mať pred sebou vyložené dve karty s rovnakým názvom.
\begin{comment}
\begin{figure}[!h]
...
\begin{minipage}[t]{\minipageSize}\centering
  ...
  \caption[Väzenie]{Pred fázou 1 si hráč musí ťahať kartu z balíčku. Pokiaľ je srdcová, môže začať svoj ťah a väzenie sa odhodí. V opačnom pípade vynecháva ťah (aj chrastiača a ťahanie na iné karty) a karta sa odhadzuje.}
  \skname{Väzenie}
  \altnames{Prigione, Prison, Jail, Vazeni}
  \label{fig:duel}
\end{minipage}
\hfill
\begin{minipage}[t]{\minipageSize}\centering
  \includegraphics[width=\cardSize\linewidth]{Modre karty/07_serpenteasonagli.png}
\caption[Chrastiač]{Pred fázou 1 si musí hráč ťahať kartu z balíčka. Pokiaľ je listová, stráca hráč 1 život. Chrastiač ostáva pred hráčom aj po spôsobení zranenia a odstráni sa len iným efektom, napr. Panikou alebo Cat Balou. Poradie kontrol na začiatku ťahu je: Dynamit, potom Väzenie, potom Chrastiač.}
  \skname{Chrestys}
  \altnames{Serpente a Sonagli, Rattlesnake, Had}
  \label{fig:panico}
\end{minipage}
\end{figure}
...
\begin{minipage}[t]{\minipageSize}\centering
 ...
 \caption[Volcanic]{Hráč môže za svoj ťah použiť ľubovoľný počet kariet Bang! na dostrel 1.}
  \label{fig:bang}
\end{minipage}
\hfill
\begin{minipage}[t]{\minipageSize}\centering
  \includegraphics[width=\cardSize\linewidth]{Modre karty/07_shotgun.png}
  \caption[Brokovnica]{Hráč, ktorý je zasiahnutý kartou Bang! z tejto zbrane musí odhodiť kartu z ruky podľa svojho výberu. Dostrel 1. Keď má hráč poslený život a má na ruke jedinú kartu, a to Pivo, odovzdáva Pivo hráćovi ktorý ho zasiahol a je vyradený z hry. }
  \skname{Brokovnica}
  \altnames{Shotgun}
  \label{fig:vedle}
\end{minipage}
...
\begin{minipage}[t]{\minipageSize}\centering
  ...
  \caption[Lemat]{Hráč môže použiť ľubovoľnú kartu z ruky ako kartu Bang!, okrem karty Vedle!. Dostrel je 1. Takto zahraná karta sa počíta do limitu Bang!.}
  \label{fig:duel}
\end{minipage}
\hfill
\begin{minipage}[t]{\minipageSize}\centering
  \includegraphics[width=\cardSize\linewidth]{Modre karty/01_schofield.png}
\caption[Schofield]{Zvýšenie dostrelu na 2.}
  \skname{Schofield}
  \label{fig:panico}
\end{minipage}
\end{figure}
...
\begin{minipage}[t]{\minipageSize}\centering
 ...
 \caption[Remington]{Zvýšenie dostrelu na 3.}
  \label{fig:bang}
\end{minipage}
\hfill
\begin{minipage}[t]{\minipageSize}\centering
  \includegraphics[width=\cardSize\linewidth]{Modre karty/01_carabine.png}
  \caption[Rev. Carabine]{Zvýšenie dostrelu na 4.}
  \altnames{Carabine}
  \skname{Karabina}
  \label{fig:vedle}
\end{minipage}
...
\begin{minipage}[t]{\minipageSize}\centering
  ...
  \caption[Winchester]{Zvýšenie dostrelu na 5.}
  \label{fig:duel}
\end{minipage}
\hfill
\begin{minipage}[t]{\minipageSize}\centering
  \includegraphics[width=\cardSize\linewidth]{Modre karty/27_Dragoon.png}
  \caption[Dragoon]{Hráč môže vo svojom ťahu zahrať o jednu kartu Bang! navyše na dostrel 2.}
  \label{fig:vedle}
\end{minipage}
\end{figure}
...
\begin{minipage}[t]{\minipageSize}\centering
 ...
 \caption[Odškodnenie]{Pokiaľ niektorý hráč odoberie alebo odhodí kartu z ruky alebo z hry inému hráčovi, ťahá si poškodený hráč kartu z balíčku. Nefunguje proti vlakovej lúpeži. }
  \skname{Odškodnenie}
  \altnames{Refund}
  \label{fig:bang}
\end{minipage}
...
\caption[Odmena]{Pokladá sa pred ľubovoľného hráča. Pokiaľ je hráč zasiahnutý kartou Bang!, hráč ktorý ho zasiahol si potiahne kartu z balíčka.}
  \skname{Odmena}
  \altnames{Taglia, Bounty}
  \label{fig:panico}
\end{minipage}
\hfill
\begin{minipage}[t]{\minipageSize}\centering
...
\begin{minipage}[t]{\minipageSize}
  \centering\includegraphics[width=\cardSize\linewidth]{Modre karty/07_fantasma.png}
...
Pokiaľ má hráč Ducha, Mŕtvy muž naňho neplatí aj keď hráč umrel ako prvý. Postava ako duch si potiahne toľko kariet vo fáze 1, koľko jej schopnosť hovorí: napr. Bill Noface si ako duch potiahne 5 kariet (1 základná + 4 za stratené životy), Pixie Pete si potiahne 3 karty. \\
