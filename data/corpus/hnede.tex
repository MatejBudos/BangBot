...
\caption[Emporio]{Na stôl sa vyloží (tvárou hore) toľko kariet koľko je hráčov v hre (živí/duch). Každý hráč si zoberie 1 kartu. Začína sa hráčom ktorý túto kartu zahral a postupuje sa po smere hodinových ručičiek.}
  \altnames{General Store, Hokynarstvo}
  \skname{Hokynarstvi}
  \label{fig:panico}
\end{minipage}
\end{figure}
...
\begin{minipage}[t]{\minipageSize}\centering
 ...
 \caption[Punch]{Vyvolá efekt Bang! na hráča vo vzdialenosti 1. Vzdialenosť ovplyvňujú karty vyložené pred hráčmi, nie však zbrane.}
  \skname{Úder}
  \altnames{Pugno, Punch}
  \label{fig:bang}
\end{minipage}
\hfill
\begin{minipage}[t]{\minipageSize}\centering
...
\begin{minipage}[t]{\minipageSize}\centering
  ...
  \caption[Útek]{Zahraním tejto karty sa môžete vyhnúť efektu karty, ktorá nie je kartou Bang!. Útek funguje aj proti kartám a efektom zasahujúcim viacerých hráčov, napr. Guľometu alebo Indiánom, ale zruší ich iba vo vzťahu k vám. Útek možno použiť aj proti kartám Väzenie, Dvojitá rána, Opätovná palba, Punch a podobne, nie však proti kartám Roztrieštená guľka alebo Dynamit.}
  \altnames{Fuga, Escape}
  \label{fig:vedle}
\end{minipage}
\hfill
\begin{minipage}[t]{\minipageSize}\centering
  ...
  \altnames{Double Trouble}
  \label{fig:duel}
\end{minipage}
\hfill
\begin{minipage}[t]{\minipageSize}\centering
  \includegraphics[width=\cardSize\linewidth]{Hnede/07_ritornodifiamma.png}
\caption[Opätovná palba]{Táto karta vyvolá efekt Vedle!; útočiaci hráč sa zároveň stáva cieľom efektu Bang!. Platí aj proti Kulometu, Houfnici a schopnosti postavy Henry Block.}
  \skname{Opätovná palba}
  \altnames{Ritorno di Fiamma}
  \label{fig:panico}
\end{minipage}
\end{figure}
...
\begin{minipage}[t]{\minipageSize}\centering
  ...
  \caption[Roztrieštená guľka]{Účinkuje ako karta Bang! na dostrel a počíta sa do limitu Bang!. Hráč podľa vášho výberu vo vzdialenosti 1 od primárneho cieľa sa zároveň stáva cieľom efektu Bang!. Túto vzdialenosť ovplyvňujú karty vyložené pred hráčmi, nie však zbrane. Sekundárny efekt Bang! je povinný a vyhodnotí sa vždy, aj keď primárny cieľ odvrátil efekt Bang! kartou Vedle!. \\
  ...
  \skname{Roztrieštená guľka}
  \altnames{Sventagliata, Fanning}
  \label{fig:vedle}
\end{minipage}
\hfill
\begin{minipage}[t]{\minipageSize}\centering
  \includegraphics[width=\cardSize\linewidth]{Hnede/07_tomahawk.png}
  \caption[Tomahawk]{Vyvolá efekt Bang! na hráča vo vzdialenosti najviac 2. Túto vzdialenosť ovplyvňujú karty vyložené pred hráčmi s výnimkou zbraní, takže Tomahawk možno použiť aj na cieľ vo vzdialenosti 1.}
  \label{fig:duel}
\end{minipage}
\hfill
\begin{minipage}[t]{\minipageSize}\centering
...
\begin{minipage}[t]{\minipageSize}\centering
 ...
 \caption[Posledné pivo]{Zahraním tejto karty si doplníte 1 život (efekt Pivo, max. na počet počiatočných životov). Túto kartu možno zahrať aj keď sú v hre iba 2 hráči.}
  \altnames{Ultimo Giro}
  \label{fig:bang}
\end{minipage}
\hfill
\begin{minipage}[t]{\minipageSize}\centering
  \includegraphics[width=\cardSize\linewidth]{Hnede/33_TrainRobberyA.png}
  \caption[Vlaková lúpež]{Zahraním tejto karty proti ľubovoľnému hráčovi vyvoláte toľko samostatných efektov Bang!, koľko má tento hráč kariet v ruke. Každý jednotlivý efekt sa vyhodnocuje osobitne: hráč môže stratiť život, zahrať kartu Vedle!, ťahať na Barel alebo použiť schopnosť postavy, napr. Jourdonnais. Táto karta sa počíta do limitu Bang!.}
  \skname{Vlaková lúpež}
  \altnames{Train Robbery}
  \label{fig:vedle}
\end{minipage}
\hfill
\begin{minipage}[t]{\minipageSize}\centering
...
\caption[K zemi!]{Hráč si vezme kartu, proti ktorej práve použil efekt Vedle!. Platí to aj proti Vlakovej lúpeži. Pri vyhnutí sa karte Knife Revolver sa najprv vyhodnotí, či sa táto karta vracia útočníkovi do ruky.}
  \altnames{Evaded}
  \label{fig:panico}
\end{minipage}
\end{figure}
...
\begin{minipage}[t]{\minipageSize}\centering
 ...
 \caption[Najhľadanejší]{Každý hráč vrátane toho, kto túto kartu zahral, ťahá vrchnú kartu balíčka. Ak je karta piková, stratí 1 život. Ak by boli takto vyradení všetci hráči naraz, vyhrávajú banditi.}
  \skname{Najhľadanejší}
  \altnames{Most Wanted}
\end{minipage}
\hfill
\begin{minipage}[t]{\minipageSize}\centering
  \includegraphics[width=\cardSize\linewidth]{Hnede/38_MoneyBag.png}
 \caption[Vak peňazí]{Ak je na vrchu odhadzovacej kopy hnedá karta, zahraním tejto karty skopírujete jej efekt. Túto kartu nemožno zahrať mimo svojho ťahu.}
  \skname{Vak peňazí}
  \altnames{Money Bag}
\end{minipage}
\hfill
\begin{minipage}[t]{\minipageSize}\centering
 ...
 \caption[Revolver s nožom]{Vyvolá efekt Bang!. Po zahraní otočíte vrchnú kartu balíčka; ak má hodnotu J, Q, K alebo A, vrátite si kartu Revolver s nožom späť do ruky.}
  \skname{Revolver s nožom}
  \altnames{Knife Revolver}
\end{minipage}
\hfill
\begin{minipage}[t]{\minipageSize}\centering
...
\begin{minipage}[t]{\minipageSize}\centering
 ...
 \caption[Nasledujúca stanica]{Posuňte vlak o 1 stanicu dopredu. Ak týmto efektom vlak dôjde na koniec trate, potiahnete si 1 kartu ešte pred vyhodnotením efektu lokomotívy.}
  \skname{Nasledujúca stanica}
  \altnames{Next Stop}
\end{minipage}
\hfill
\begin{minipage}[t]{\minipageSize}\centering
  \includegraphics[width=\cardSize\linewidth]{Hnede/39_FullSteam.png}
 \caption[Plnou parou vpred]{Posuňte vlak rovno na koniec trate a potom sa rozhodnite, či sa efekt lokomotívy nevyhodnotí vôbec, alebo sa vyhodnotí dvakrát za sebou pre všetkých hráčov.}
  \skname{Plnou parou vpred}
  \altnames{Full Steam Ahead}
\end{minipage}
\hfill
\begin{minipage}[t]{\minipageSize}\centering
