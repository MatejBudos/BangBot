...
\begin{minipage}[t]{\minipageSize}\centering
 ...
 \caption[Krytý voz]{Hráč, ktorý túto kartu zahrá zoberie kartu ľubovoľnému hráčovi z ruky alebo z vyložených kariet na neobmedzený dosah. Dá sa zahrať iba vo svojom ťahu.}
  \skname{Krytý voz}
  \altnames{Conestoga}
  \label{fig:Vuz}
\end{minipage}
