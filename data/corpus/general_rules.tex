...
\begin{itemize}
    \item Kartu \textbf{Vedle!} a kartu \textbf{Pivo} možno hrať aj mimo vlastného ťahu, ale iba v prípadoch, ktoré dovoľujú základné pravidlá alebo iné vyslovené pravidlo.
    ...
    \item Hráči sa nesmú navzájom pýtať na karty priamo súvisiace s hraním (napr. „Máš Vedle!?"). Môžu sa vyjadrovať všeobecne, naznačovať a komentovať, ale priame otázky o konkrétnych kartách na ruke nie sú povolené.
\end{itemize}
